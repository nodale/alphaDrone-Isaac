...
class DroneEnv(DirectRLEnv):
    ...
    def _pre_physics_step(self, actions: torch.Tensor):
        ...
        if self.loop_counter % self.steps_per_sample == 0:
            if self.sitl:
                ...
                # quick_v11a's T_n -> thrust_kg curve (thrust_curves.md), converted to N
                self.sitl_actuation[..., 2] = (0.96205 * actuation_t ** 2 + 0.35267 * actuation_t - 0.06114) * 9.81
                self.sitl_moment[..., 2] = self.sitl_actuation[..., 2] * 0.021867
    ...
    def _apply_action(self):
        ...
        if self.sitl:
            ...
            self.drone.moment_noise = self.noise_scale * vib * 0.021867 * 0.0
            ...
            self.drone.moment_noise = self.noise_scale * vib * 0.021867
